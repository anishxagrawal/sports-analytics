...
Notes:
    ...
    - Uses a fine-tuned YOLOv8 model with CUSTOM classes
      (current model: 0 = Player, 1 = Ball, 2 = Referee)
"""
...
# Explicit class-name mapping for safety and clarity
CLASS_NAME_MAP = {
    0: "Player",
    1: "Ball",
    2: "Referee",
...
class YOLODetector:
    ...
    def __init__(
        ...
        Args:
            ...
            allowed_classes: Set of allowed class IDs
                             (e.g., {0, 1} for Player and Ball).
                             None allows all classes.
    ...
    def detect(self, frame: np.ndarray) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of detection dictionaries, each containing:
                - bbox: tuple (x1, y1, x2, y2) in pixel coordinates (float)
                - confidence: float confidence score [0.0, 1.0]
                - class_id: int class identifier (model-defined)
